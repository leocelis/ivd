...
> [`external/canon/CANON_PRD.md`](https://github.com/leocelis/canon).
...
- **Phase 0c (Browser extension surface — `Canon Dots`):** Designed, not yet shipped. See `external/canon/CANON_PRD.md` §11.0c.
