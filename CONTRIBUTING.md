...
Runtime checks feed the live [enforcement seal](https://eu.api.complyedge.io/v1/public/badge/ivd.svg) and [trust page](https://trust.complyedge.io/ivd). See [`docs/integrations/COMPLYEDGE.md`](docs/integrations/COMPLYEDGE.md).
