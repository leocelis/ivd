...
- Original framework essay (proto-form): `internal/frameworks/Judgment_Feedback_Loop_Framework.md` *(superseded — header redirect)*
...
- **v1.0** (2026-03-21) — Initial canonical version. Promotes the Judgment Feedback Loop
  framework from an internal monorepo to operational IVD canon. Establishes Principle 9, the
