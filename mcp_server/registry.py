...
IVD MCP Tool Registry — registration and dispatch for all 28 tools.
  ...
  - 4  Canon tools  (Human Translation Layer, Phase 0b — hosted inside this
                     ...
                     limitless/ventures/canon/CANON_PRD.md v0.7 §11.0b and
                     limitless/ventures/canon/CANON_TECH_SPEC.md v0.6 §9B.)
"""
...
def get_all_tools() -> List[Tool]:
    ...
    return [
        ...
        # See limitless/ventures/canon/CANON_PRD.md v0.7 §11.0b.
        # -------------------------------------------------------------------
        Tool(
            name="canon_render",
