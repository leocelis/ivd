...
echo ""
echo "Other tools:"
echo "  - ./mcp_server/devops/deploy.sh   # Deploy to DigitalOcean"
echo "  - ./mcp_server/devops/logs.sh     # Stream production logs"
echo "  - ./mcp_server/devops/keys.sh     # Manage API keys"
echo "  - ./mcp_server/devops/embed.sh    # Regenerate embeddings"
echo ""
