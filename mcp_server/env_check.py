...
When adding a new env var dependency:
  ...
  2. Add it to your deployment environment spec (e.g. DO app.yaml)
...
def check_and_warn(transport: str = "sse") -> None:
    ...
    if transport != "stdio":
        ...
        print(colored(f"[{NAME}] Add the missing vars to your deployment environment spec and redeploy.", "red"))
        raise SystemExit(1)
    else:
